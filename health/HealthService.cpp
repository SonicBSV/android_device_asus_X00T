...
#define LOG_TAG "android.hardware.health@2.0-service.X00T"
...
namespace {
using ::device::X00T::health::CycleCountBackupRestore;
using ::device::X00T::health::LearnedCapacityBackupRestore;
